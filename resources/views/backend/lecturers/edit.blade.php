        ...
        <div class="intro-y col-span-12 lg:col-span-6">
            <form action="{{ route('lecturers.update', $lecturer->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="magv" id="magv" class="form-control" value="{{ $lecturer->magv }}" readonly>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="phone_number" id="phone_number" class="form-control" value="{{ $lecturer->phone_number }}" required>
                </div>

                <div class="mb-4">
                    <label for="faculty" class="form-label">Khoa</label>
                    <input type="text" name="faculty" id="faculty" class="form-control" value="{{ $lecturer->faculty }}">
                </div>

                <div class="mb-4">
                    <label for="major" class="form-label">Chuyên ngành</label>
                    <input type="text" name="major" id="major" class="form-control" value="{{ $lecturer->major }}">
                </div>

                <div class="mb-4">
                    <label for="degree" class="form-label">Học vị</label>
                    <select name="degree" id="degree" class="form-select">
                        <option value="" {{ $lecturer->degree == '' ? 'selected' : '' }}>Chọn học vị</option>
